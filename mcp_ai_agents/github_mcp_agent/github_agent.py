...
with col1:
    repo = st.text_input("Repository", value="MrBozkay/Awesome_Agent_Rag_LLMs_apps", help="Format: owner/repo")
with col2:
...
if 'result' not in locals():
    st.markdown(
        ...
        <ol>
            ...
            <li>Specify a repository (e.g., MrBozkay/Awesome_Agent_Rag_LLMs_apps)</li>
